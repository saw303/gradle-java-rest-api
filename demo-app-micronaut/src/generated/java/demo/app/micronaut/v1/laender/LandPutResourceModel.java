...
@Generated(
    date = "2019-02-11T14:56:02.264Z",
    comments = "Specification filename: land.v1.json",
    value = "ch.silviowangler.restapi"
)
public class LandPutResourceModel implements Serializable, ResourceModel {
  ...
  public boolean equals(Object other) {
    ...
    if (! (other instanceof LandPutResourceModel)) return false;
    LandPutResourceModel that = (LandPutResourceModel) other;
