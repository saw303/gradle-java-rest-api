...
@Generated(
    date = "2019-02-11T14:56:02.327Z",
    comments = "Specification filename: land.ort.v1.json",
    value = "ch.silviowangler.restapi"
)
public class OrtPostResourceModel implements Serializable, ResourceModel {
  ...
  public boolean equals(Object other) {
    ...
    if (! (other instanceof OrtPostResourceModel)) return false;
    OrtPostResourceModel that = (OrtPostResourceModel) other;
